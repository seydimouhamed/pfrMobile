...
//  public function send($phone=null, $message=null)
//  {
//     // $config = array(
//     //     'clientId' => config('app.clientId'),
//     //     'cleintSecret' => config('app.cleintSecret'),
//     // );

//     $config = array(
//             'token' => 'Basic RkZaYUtJbmFVQWVyRHJHc1FRbFQ3bFRtek1pOVVFOTQ6Mk80V1d2SEx2UHFmYnc0Uw==',
//             'clientId' => 'FFZaKInaUAerDrGsQQlT7lTmzMi9UE94',
//             'cleintSecret' => '2O4WWvHLvPqfbw4S',
//         );
...
//         $senderAddress = "tel:+221771184610";
//         $receiveAddress= "tel:+22177184610";
//         $message= 'Hello World';
//         $senderName = 'SMB';

//         $osms->sendSms($senderAddress, $receiveAddress, $message, $senderName);
//    // }
...
class Sms {
     ...
     * @var string
     */
    protected $clientId = 'FFZaKInaUAerDrGsQQlT7lTmzMi9UE94';
     ...
     * @var string
     */
    protected $clientSecret = '2O4WWvHLvPqfbw4S';
